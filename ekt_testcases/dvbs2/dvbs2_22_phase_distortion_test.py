...
if my_file.exists():
    ...
    write_json_file("../../ekt_json/dvbs2_22_phase_distortion_test.json", dict_test_parame_result)
...
if __name__ == '__main__':
   ...
   """
    load_dict = read_json_file("../../ekt_json/dvbs2_22_phase_distortion_test.json")
    sfu_ip = "192.168.1.50"
    ...
    for LOCK_PARAMETER in load_dict.get("test_parame_result"):
        ...
        for PARAMETER in LOCK_PARAMETER[2]:
            ...
            write_json_file("../../ekt_json/dvbs2_22_phase_distortion_test.json", load_dict)
            dvbs2_22_phase_distortion_test_json_to_csv("../../ekt_json/dvbs2_22_phase_distortion_test.json",
                                                       "../../ekt_test_report/dvbs2_22_phase_distortion_test.csv")

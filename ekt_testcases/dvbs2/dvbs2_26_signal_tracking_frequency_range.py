...
SYMBOL_RATE_FREQUENCY_5M = ["5.000000e6", "05000",
                            [["950", "952", LEVEL_50_950, LEVEL_OFFSET_950], ["950", "948", LEVEL_50_950, LEVEL_OFFSET_950],
                             ["1550", "1552", LEVEL_50_1550, LEVEL_OFFSET_1550], ["1550", "1548", LEVEL_50_1550, LEVEL_OFFSET_1550],
                             ["2150", "2152", LEVEL_50_2150, LEVEL_OFFSET_2150], ["2150", "2148", LEVEL_50_2150, LEVEL_OFFSET_2150]]]
    ...
    for LOCK_PARAMETER in load_dict.get("test_parame_result"):
        ...
        if lock_state == "1":
            ...
            write_test_result("../../ekt_log/test_result_sfu.txt",
                              (
                                      "dvbs2_26_signal_tracking_frequency_range: current_time:{}, frequency:{} MHz,symbol_rate:{} Ksym/s,level:{} dbm, {}".format(
        ...
        for PARAMETER in LOCK_PARAMETER[3]:
            ...
            print (
                "dvbs2_26_signal_tracking_frequency_range: current_time:{}, coderate:{}, frequency:{} MHz,symbol_rate:{} Ksym/s,level:{} dbm, Mosaic results:{}".format(

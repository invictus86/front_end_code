...
my_file = Path("../../ekt_json/dvbs2_18_dynamic_range_awng_min_level.json")
if my_file.exists():
    pass
else:
    ...
    write_json_file("../../ekt_json/dvbs2_18_dynamic_range_awng_min_level.json", dict_test_parame_result)
    ...
    for LOCK_PARAMETER in load_dict.get("test_parame_result"):
        ...
        if lock_state == "1":
            ...
            write_test_result("../../ekt_log/test_result_sfu.txt",
                              (
                                      "dvbs2_18_dynamic_range_awng_min_level: current_time:{}, frequency:{} MHz,symbol_rate:{} Ksym/s,level: {}, {}".format(
        ...
        for PARAMETER in LOCK_PARAMETER[2]:
            ...
            dvbs2_18_dynamic_min_json_to_csv("../../ekt_json/dvbs2_18_dynamic_range_awng_min_level.json",
                                             "../../ekt_test_report/dvbs2_18_dynamic_range_awng_min_level.csv")

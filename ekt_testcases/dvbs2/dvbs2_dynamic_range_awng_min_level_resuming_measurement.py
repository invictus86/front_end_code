...
from ekt_lib.ekt_utils import write_test_result, read_ekt_config_data, write_json_file
...
write_json_file("../../ekt_json/dvbs2_dynamic_range_awng_min_level_resuming_measurement.json", dict_test_parame_result)

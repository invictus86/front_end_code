...
my_file = Path("../../ekt_json/dvbs2_18_dynamic_range_awng_sensitivity_level.json")
if my_file.exists():
    pass
else:
        ...
        for FREQUENCY_LEVEL_OFFSET in DVBS_S2_FREQUENCY_LEVEL_OFFSET:
            ...
            for MODULATION in dict_config_data.get("MODULATION"):
                ...
                for code_rate_cn in CURRENT_DVBS2_CODE_RATE_CN:
                    list_test_result.append([MODULATION, code_rate_cn, None, None, None])
            list_test_parame_result.append([SYMBOL_RATE, FREQUENCY_LEVEL_OFFSET, list_test_result])
    dict_test_parame_result["test_parame_result"] = list_test_parame_result

    write_json_file("../../ekt_json/dvbs2_18_dynamic_range_awng_sensitivity_level.json", dict_test_parame_result)
...
if __name__ == '__main__':
    ...
    dvbs2_18_dynamic_min_json_class_test("../../ekt_json/dvbs2_18_dynamic_range_awng_sensitivity_level.json")

    load_dict = read_json_file("../../ekt_json/dvbs2_18_dynamic_range_awng_sensitivity_level.json")
    ...
    for LOCK_PARAMETER in load_dict.get("test_parame_result"):
        ...
        if lock_state == "1":
            ...
            write_test_result("../../ekt_log/test_result_sfu.txt",
                              (
                                      "dvbs2_18_dynamic_range_awng_sensitivity_level: current_time:{}, frequency:{} MHz,symbol_rate:{} Ksym/s,level: {}, {}".format(
        ...
        for PARAMETER in LOCK_PARAMETER[2]:
            ...
            write_json_file("../../ekt_json/dvbs2_18_dynamic_range_awng_sensitivity_level.json", load_dict)
            write_test_result("../../ekt_log/test_result_sfu.txt",
                              "dvbs2_18_dynamic_range_awng_sensitivity_level: current_time:{}, modulation: {}, coderate:{}, frequency:{} MHz,symbol_rate:{} Ksym/s,level:{} dbm, Mosaic results:{}".format(
            ...
            print (
                "dvbs2_18_dynamic_range_awng_sensitivity_level: current_time:{}, modulation: {},coderate:{}, frequency:{} MHz,symbol_rate:{} Ksym/s,{}".format(
                    datetime.datetime.now().strftime('%Y-%m-%d %H:%M:%S'), MODULATION, code_rate_cn[0],
            ...
            if test_result is None:
                pass
            elif float(test_result) <= ekt_cfg.DVBS2_18_SPEC:
                PARAMETER[4] = "Pass"
            elif float(test_result) > ekt_cfg.DVBS2_18_SPEC:
                PARAMETER[4] = "Fail"
            else:
                PARAMETER[4] = "test result err"
            write_json_file("../../ekt_json/dvbs2_18_dynamic_range_awng_sensitivity_level.json", load_dict)
            dvbs2_18_dynamic_min_json_to_csv("../../ekt_json/dvbs2_18_dynamic_range_awng_sensitivity_level.json",
                                             "../../ekt_test_report/dvbs2_18_dynamic_range_awng_sensitivity_level.csv")

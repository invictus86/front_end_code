...
if __name__ == '__main__':
    ...
    for LOCK_PARAMETER in load_dict.get("test_parame_result"):
            ...
            write_test_result("../../ekt_log/test_result_sfu.txt",
                              (
                                      "dvbs2_25_signal_acquisition_frequency_range: current_time:{}, frequency：{} MHz，symbol_rate：{} Ksym/s，level：{} dbm, {}".format(
                                          ...
                                          FREQUENCY_OFFSET[1], SYMBOL_RATE_FREQUENCY[1], FREQUENCY_OFFSET[2], "锁台失败") + "\n"))
            continue
        else:
        ...
        for PARAMETER in LOCK_PARAMETER[3]:
            ...
            print (
                "dvbs2_25_signal_acquisition_frequency_range: current_time:{}, coderate：{}, frequency：{} MHz，symbol_rate：{} Ksym/s，level：{} dbm, 马赛克检测结果：{}".format(

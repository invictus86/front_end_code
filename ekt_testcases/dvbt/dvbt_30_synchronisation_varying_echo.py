...
from ekt_lib.ekt_utils import write_test_result, write_json_file, read_json_file, find_level_offset_by_frequency, \
    dvbt2_30_synchronisation_varying_echo_json_to_csv
...
PARAMETER_LIST = [
    [FFT_SIZE_8K, MODULATION_64QAM, CODE_RATE_2_3, GUARD_G1_8, 26.2, 10, 0, None],
    [FFT_SIZE_8K, MODULATION_64QAM, CODE_RATE_2_3, GUARD_G1_8, 26.2, 56, 0, None],
    [FFT_SIZE_8K, MODULATION_64QAM, CODE_RATE_2_3, GUARD_G1_8, 26.2, 105, 0, None],

    [FFT_SIZE_8K, MODULATION_64QAM, CODE_RATE_2_3, GUARD_G1_4, 26.2, 10, 0, None],
    [FFT_SIZE_8K, MODULATION_64QAM, CODE_RATE_2_3, GUARD_G1_4, 26.2, 56, 0, None],
    [FFT_SIZE_8K, MODULATION_64QAM, CODE_RATE_2_3, GUARD_G1_4, 26.2, 112.1, 0, None],
    [FFT_SIZE_8K, MODULATION_64QAM, CODE_RATE_2_3, GUARD_G1_4, 26.2, 130, 0, None],
    [FFT_SIZE_8K, MODULATION_64QAM, CODE_RATE_2_3, GUARD_G1_4, 26.2, 170, 0, None],
    [FFT_SIZE_8K, MODULATION_64QAM, CODE_RATE_2_3, GUARD_G1_4, 26.2, 212, 0, None],

    [FFT_SIZE_8K, MODULATION_64QAM, CODE_RATE_3_4, GUARD_G1_4, 30.6, 10, 0, None],
    [FFT_SIZE_8K, MODULATION_64QAM, CODE_RATE_3_4, GUARD_G1_4, 30.6, 56, 0, None],
    [FFT_SIZE_8K, MODULATION_64QAM, CODE_RATE_3_4, GUARD_G1_4, 30.6, 112.1, 0, None],
    [FFT_SIZE_8K, MODULATION_64QAM, CODE_RATE_3_4, GUARD_G1_4, 30.6, 130, 0, None],
    [FFT_SIZE_8K, MODULATION_64QAM, CODE_RATE_3_4, GUARD_G1_4, 30.6, 170, 0, None],
    [FFT_SIZE_8K, MODULATION_64QAM, CODE_RATE_3_4, GUARD_G1_4, 30.6, 212, 0, None],
]

my_file = Path("../../ekt_json/dvbt_30_synchronisation_varying_echo.json")
if my_file.exists():
    pass
else:
    dict_test_parame_result = {}
    dict_test_parame_result["test_parame_result"] = PARAMETER_LIST
    write_json_file("../../ekt_json/dvbt_30_synchronisation_varying_echo.json",
                    dict_test_parame_result)
...
if __name__ == '__main__':
    ...
    if lock_state == "1":
        ...
        write_test_result("../../ekt_log/test_result_sfu.txt",
                          (
                                  "dvbt_30_synchronisation_varying_echo: current_time:{}, frequency：{} MHz，bandwidth：{} Ksym/s, {}".format(
    ...
    for PARAMETER in load_dict.get("test_parame_result"):
        ...
        write_json_file("../../ekt_json/dvbt_30_synchronisation_varying_echo.json", load_dict)
        dvbt2_30_synchronisation_varying_echo_json_to_csv(
            "../../ekt_json/dvbt_30_synchronisation_varying_echo.json",
            "../../ekt_test_report/dvbt_30_synchronisation_varying_echo.csv")

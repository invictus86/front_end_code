    ...
    for FREQUENCY_LEVEL_OFFSET in DVBT_T2_FREQUENCY_LEVEL_OFFSET:
        ...
        for MODULATION_CODERATE_SPEC in MODULATION__CODERATE_SPEC_LIST:
            ...
            try:
                ...
                print "dvbt2_performance_gaussian_channel: current_time:{}, modulation: {} coderate：{}, frequency：{} MHz，bandwidth：{} MHZ，{}".format(
                ...
                write_test_result("../../ekt_log/test_result_sfu.txt",
                                  "dvbt2_performance_gaussian_channel: current_time:{}, modulation: {} coderate：{}, frequency：{} MHz，bandwidth：{} MHZ，{}".format(
                                      datetime.datetime.now().strftime('%Y-%m-%d %H:%M:%S'),

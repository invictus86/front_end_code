...
from ekt_lib.ekt_utils import write_test_result, write_json_file, read_json_file, dvbt_4_centre_frequencies_json_to_csv
...
my_file = Path("../../ekt_json/dvbt_4_centre_frequencies.json")
if my_file.exists():
    pass
else:
    dict_test_parame_result = {}
    dict_test_parame_result["test_parame_result"] = FREQUENCY_BW_LIST
    write_json_file("../../ekt_json/dvbt_4_centre_frequencies.json", dict_test_parame_result)
...
if __name__ == '__main__':
    ...
    """
    load_dict = read_json_file("../../ekt_json/dvbt_4_centre_frequencies.json")
    sfu_ip = "192.168.1.50"
    ...
    for FREQUENCY_BW in load_dict.get("test_parame_result"):
        ...
        write_json_file("../../ekt_json/dvbt_4_centre_frequencies.json", load_dict)
        dvbt_4_centre_frequencies_json_to_csv(
            "../../ekt_json/dvbt_4_centre_frequencies.json",
            "../../ekt_test_report/dvbt_4_centre_frequencies.csv")

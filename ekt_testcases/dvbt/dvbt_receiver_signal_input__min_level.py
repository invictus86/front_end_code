    ...
    for FREQUENCY_LEVEL_OFFSET in DVBT_T2_FREQUENCY_LEVEL_OFFSET:
        ...
        if lock_state == "1":
            ...
            write_test_result("../../ekt_log/test_result_sfu.txt",
                              (
                                      "dvbt_receiver_signal_input__min_level: current_time:{}, frequency：{} MHz，bandwidth：{} Ksym/s， {}".format(
        ...
        for MODULATION_CODERATE_SPEC in CURRENT_MODULATION__CODERATE_SPEC_LIST:
            ...
            try:
                ...
                print "dvbt_receiver_signal_input__min_level: current_time:{}, modulation: {},coderate：{}, guard:{}, frequency：{} MHz，bandwidth：{} MHZ，{}".format(
                ...
                write_test_result("../../ekt_log/test_result_sfu.txt",
                                  "dvbt_receiver_signal_input__min_level: current_time:{}, modulation: {}, coderate：{}, guard:{},frequency：{} MHz，bandwidth：{} MHZ，{}".format(
                                      datetime.datetime.now().strftime('%Y-%m-%d %H:%M:%S'),

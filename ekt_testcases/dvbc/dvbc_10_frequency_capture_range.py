...
from ekt_lib.ekt_utils import write_test_result, read_ekt_config_data, write_json_file, read_json_file, dvbc_10_frequency_capture_range_json_to_csv
    ...
    for LOCK_PARAMETER in load_dict.get("test_parame_result"):
        ...
        if lock_state == "1":
            ...
            write_test_result("../../ekt_log/test_result_sfu.txt",
                              (
                                      "dvbc_10_frequency_capture_range: current_time:{}, frequency:{} MHz,symbol_rate:{} Ksym/s,level:{} dbm, {}".format(
        ...
        for PARAMETER in LOCK_PARAMETER[2]:
            ...
            print (
                "dvbc_10_frequency_capture_range: current_time:{}, frequency:{} MHz,symbol_rate:{} Ksym/s,level:{} dbm, Mosaic result:{}".format(
                    datetime.datetime.now().strftime('%Y-%m-%d %H:%M:%S'),
            ...
            write_json_file("../../ekt_json/dvbc_10_frequency_capture_range.json", load_dict)
            dvbc_10_frequency_capture_range_json_to_csv("../../ekt_json/dvbc_10_frequency_capture_range.json",
                                                    "../../ekt_test_report/dvbc_10_frequency_capture_range.csv")

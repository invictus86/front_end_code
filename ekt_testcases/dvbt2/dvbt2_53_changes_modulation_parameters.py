...
PARAMETER_LIST = [
    ...
    [FFT_SIZE_32KE, MODULATION_256QAM, 'PP4', CODE_RATE_2_3, GUARD_G1_32, 8, 48, None],
    [FFT_SIZE_32KE, MODULATION_256QAM, 'PP4', CODE_RATE_2_3, GUARD_G1_16, 8, 48, None],
    [FFT_SIZE_32KE, MODULATION_256QAM, 'PP8', CODE_RATE_2_3, GUARD_G1_8, 8, 48, None],
    [FFT_SIZE_16K, MODULATION_256QAM, 'PP1', CODE_RATE_2_3, GUARD_G1_4, 8, 48, None],
    [FFT_SIZE_32KE, MODULATION_256QAM, 'PP7', CODE_RATE_2_3, GUARD_G1_128, 8, 48, None],
    [FFT_SIZE_32KE, MODULATION_256QAM, 'PP8', CODE_RATE_2_3, GUARD_G19_128, 8, 44, None],
    [FFT_SIZE_32KE, MODULATION_256QAM, 'PP8', CODE_RATE_2_3, GUARD_G19_256, 8, 44, None],

    [FFT_SIZE_32KE, MODULATION_256QAM, 'PP2', CODE_RATE_2_3, GUARD_G1_16, 8, 48, None],
    [FFT_SIZE_32KE, MODULATION_256QAM, 'PP4', CODE_RATE_2_3, GUARD_G1_16, 8, 48, None],
    [FFT_SIZE_32KE, MODULATION_256QAM, 'PP6', CODE_RATE_2_3, GUARD_G1_32, 8, 48, None],
    [FFT_SIZE_32KE, MODULATION_256QAM, 'PP7', CODE_RATE_2_3, GUARD_G1_128, 8, 48, None],
...
if __name__ == '__main__':
    ...
    for PARAMETER in load_dict.get("test_parame_result"):
        ...
        print (
            "dvbt2_53_changes_modulation_parameters: current_time:{}, modulation: {},coderate:{}, frequency:{} MHz,bandwidth:{} MHZ,{}".format(

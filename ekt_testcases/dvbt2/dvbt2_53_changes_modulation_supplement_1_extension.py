...
from ekt_lib.ekt_utils import write_test_result, find_level_offset_by_frequency, write_json_file, read_json_file, \
    dvbt2_53_changes_modulation_parameters_to_csv, get_ldata_from_lf_fftsize
...
PARAMETER_LIST = [
    [KN32, MODULATION_256QAM, 'PP2', CODE_RATE_2_3, GUARD_G1_16, 8, 62, None],
    [KE32, MODULATION_256QAM, 'PP2', CODE_RATE_2_3, GUARD_G1_16, 8, 62, None]
]


my_file = Path("../../ekt_json/dvbt2_53_changes_modulation_supplement_1_extension.json")
if my_file.exists():
    pass
else:
    ...
    write_json_file("../../ekt_json/dvbt2_53_changes_modulation_supplement_1_extension.json",
                    dict_test_parame_result)
...
if __name__ == '__main__':
    ...
    """
    load_dict = read_json_file("../../ekt_json/dvbt2_53_changes_modulation_supplement_1_extension.json")
    sfu_ip = "192.168.1.50"
    ...
    if lock_state == "1":
        ...
        write_test_result("../../ekt_log/test_result_sfu.txt",
                          (
                                  "dvbt2_53_changes_modulation_supplement_1_extension: current_time:{}, frequency:{} MHz,bandwidth:{} Ksym/s, {}".format(
    ...
    for PARAMETER in load_dict.get("test_parame_result"):
        ...
        print (
            "dvbt2_53_changes_modulation_supplement_1_extension: current_time:{}, modulation: {},coderate:{}, frequency:{} MHz,bandwidth:{} MHZ,{}".format(
        ...
        write_json_file(
            "../../ekt_json/dvbt2_53_changes_modulation_supplement_1_extension.json", load_dict)
        dvbt2_53_changes_modulation_parameters_to_csv(
            "../../ekt_json/dvbt2_53_changes_modulation_supplement_1_extension.json",
            "../../ekt_test_report/dvbt2_53_changes_modulation_supplement_1_extension.csv")

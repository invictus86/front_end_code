...
my_file = Path("../../ekt_json/dvbt2_57_performance_gaussian_channel_resuming_measurement.json")
if my_file.exists():
    pass
else:
    ...
    write_json_file("../../ekt_json/dvbt2_57_performance_gaussian_channel_resuming_measurement.json",
                    dict_test_parame_result)
...
if __name__ == '__main__':
    ...
    for FREQUENCY_LEVEL_OFFSET in load_dict.get("test_parame_result"):
        ...
        specan = Ektsfu(sfu_ip)
        specan.set_frequency_frequency_frequency(str(FREQUENCY_LEVEL_OFFSET[0][0]) + "MHz")
        specan = Ektsfu(sfu_ip)
        ...
        if lock_state == "1":
            ...
            write_test_result("../../ekt_log/test_result_sfu.txt",
                              (
                                      "dvbt2_57_performance_gaussian_channel_resuming_measuremen: current_time:{}, frequency：{} MHz，bandwidth：{} Ksym/s, {}".format(
        ...
        for MODULATION_CODERATE_SPEC in FREQUENCY_LEVEL_OFFSET[1]:
            ...
            print "dvbt2_57_performance_gaussian_channel_resuming_measuremen: current_time:{}, modulation: {} coderate：{}, frequency：{} MHz，bandwidth：{} MHZ，{}".format(
            ...
            write_test_result("../../ekt_log/test_result_sfu.txt",
                              "dvbt2_57_performance_gaussian_channel_resuming_measuremen: current_time:{}, modulation: {} coderate：{}, frequency：{} MHz，bandwidth：{} MHZ，{}".format(
                                  datetime.datetime.now().strftime('%Y-%m-%d %H:%M:%S'),
            ...
            write_json_file("../../ekt_json/dvbt2_57_performance_gaussian_channel_resuming_measuremen.json",
                            load_dict)
            dvbt2_57_gaussian_channel_json_to_csv(
                "../../ekt_json/dvbt2_57_performance_gaussian_channel_resuming_measuremen.json",
                "../../ekt_test_report/dvbt2_57_performance_gaussian_channel_resuming_measuremen.csv")

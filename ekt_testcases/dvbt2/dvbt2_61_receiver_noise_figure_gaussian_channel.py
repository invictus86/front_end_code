...
MODULATION__CODERATE_SPEC_LIST = [
    [MODULATION_QPSK, CODE_RATE_1_2, 6.0],
    [MODULATION_QPSK, CODE_RATE_3_5, 6.0],
    [MODULATION_QPSK, CODE_RATE_2_3, 6.0],
    [MODULATION_QPSK, CODE_RATE_3_4, 6.0],
    [MODULATION_QPSK, CODE_RATE_4_5, 6.0],
    [MODULATION_QPSK, CODE_RATE_5_6, 6.0],
    [MODULATION_16QAM, CODE_RATE_1_2, 6.0],
    [MODULATION_16QAM, CODE_RATE_3_5, 6.0],
    [MODULATION_16QAM, CODE_RATE_2_3, 6.0],
    [MODULATION_16QAM, CODE_RATE_3_4, 6.0],
    [MODULATION_16QAM, CODE_RATE_4_5, 6.0],
    [MODULATION_16QAM, CODE_RATE_5_6, 6.0],
    [MODULATION_64QAM, CODE_RATE_1_2, 6.0],
    [MODULATION_64QAM, CODE_RATE_3_5, 6.0],
    [MODULATION_64QAM, CODE_RATE_2_3, 6.0],
    [MODULATION_64QAM, CODE_RATE_3_4, 6.0],
    [MODULATION_64QAM, CODE_RATE_4_5, 6.0],
    [MODULATION_64QAM, CODE_RATE_5_6, 6.0],
    [MODULATION_256QAM, CODE_RATE_1_2, 6.0],
    [MODULATION_256QAM, CODE_RATE_3_5, 6.0],
    [MODULATION_256QAM, CODE_RATE_2_3, 6.0],
    [MODULATION_256QAM, CODE_RATE_3_4, 6.0],
    [MODULATION_256QAM, CODE_RATE_4_5, 6.0],
    [MODULATION_256QAM, CODE_RATE_5_6, 6.0]]
    ...
    for FREQUENCY_LEVEL_OFFSET in DVBT_T2_FREQUENCY_LEVEL_OFFSET:
        ...
        if lock_state == "1":
            ...
            write_test_result("../../ekt_log/test_result_sfu.txt",
                              (
                                      "dvbt_performance_gaussian_channel: current_time:{}, frequency：{} MHz，bandwidth：{} Ksym/s, {}".format(
        ...
        for MODULATION_CODERATE_SPEC in MODULATION__CODERATE_SPEC_LIST:
            ...
            try:
                res = iterate_to_find_threshold_noise_cn_step_by_step(sfu_ip, MODULATION_CODERATE_SPEC[2] + 3)
                print "dvbt_performance_gaussian_channel: current_time:{}, modulation: {} coderate：{}, frequency：{} MHz，bandwidth：{} MHZ，{}".format(
                ...
                write_test_result("../../ekt_log/test_result_sfu.txt",
                                  "dvbt_performance_gaussian_channel: current_time:{}, modulation: {} coderate：{}, frequency：{} MHz，bandwidth：{} MHZ，{}".format(
                                      datetime.datetime.now().strftime('%Y-%m-%d %H:%M:%S'),

...
from ekt_lib.ekt_utils import write_test_result, find_level_offset_by_frequency, write_json_file, read_json_file, \
    dvbt2_36_signal_bandwidths_json_to_csv
...
KN32 = "M32K"
PARAMETER_LIST = [
    [FREQUENCY_199, LEVEL_OFFSET_198_5, LEVEL_50_199, 7, KN32, MODULATION_256QAM, "PP2", CODE_RATE_2_3, GUARD_G19_256, None],
    [FREQUENCY_666, LEVEL_OFFSET_666, LEVEL_50_666, 8, KN32, MODULATION_256QAM, "PP4", CODE_RATE_2_3, GUARD_G1_16, None],

    [FREQUENCY_199, LEVEL_OFFSET_198_5, LEVEL_50_199, 7, KE32, MODULATION_256QAM, "PP2", CODE_RATE_2_3, GUARD_G19_256, None],
    [FREQUENCY_666, LEVEL_OFFSET_666, LEVEL_50_666, 8, KE32, MODULATION_256QAM, "PP4", CODE_RATE_2_3, GUARD_G1_16, None],

    [FREQUENCY_199, LEVEL_OFFSET_198_5, LEVEL_50_199, 8, KE32, MODULATION_256QAM, "PP2", CODE_RATE_3_5, GUARD_G19_256, None],
]

my_file = Path("../../ekt_json/dvbt2_36_signal_bandwidths.json")
if my_file.exists():
    pass
else:
    dict_test_parame_result = {}
    dict_test_parame_result["test_parame_result"] = PARAMETER_LIST
    write_json_file("../../ekt_json/dvbt2_36_signal_bandwidths.json",
                    dict_test_parame_result)
...
if __name__ == '__main__':
    ...
    """
    load_dict = read_json_file("../../ekt_json/dvbt2_36_signal_bandwidths.json")
    sfu_ip = "192.168.1.50"
    ...
    for PARAMETER in load_dict.get("test_parame_result"):
        ...
        write_json_file(
            "../../ekt_json/dvbt2_36_signal_bandwidths.json", load_dict)
        dvbt2_36_signal_bandwidths_json_to_csv(
            "../../ekt_json/dvbt2_36_signal_bandwidths.json",
            "../../ekt_test_report/dvbt2_36_signal_bandwidths.csv")

...
if my_file.exists():
    ...
    write_json_file("../../ekt_json/dvbt2_54_time_interleaving.json", dict_test_parame_result)
...
if __name__ == '__main__':
    ...
    """
    load_dict = read_json_file("../../ekt_json/dvbt2_54_time_interleaving.json")
    sfu_ip = "192.168.1.50"
    ...
    specan = Ektsfu(sfu_ip)
    specan.set_digitaltv_bicm_constellation_dvbt2("T256")
    specan = Ektsfu(sfu_ip)
    ...
    if lock_state == "1":
        ...
        write_test_result("../../ekt_log/test_result_sfu.txt",
                          (
                                  "dvbt2_54_time_interleaving: current_time:{}, frequency:{} MHz,bandwidth:{} Ksym/s, {}".format(
    ...
    for PARAMETER in load_dict.get("test_parame_result"):
        ...
        print (
            "dvbt2_54_time_interleaving: current_time:{}, modulation: {},coderate:{}, frequency:{} MHz,bandwidth:{} MHZ,{}".format(
        ...
        PARAMETER[4] = test_result
        write_json_file(
            "../../ekt_json/dvbt2_54_time_interleaving.json", load_dict)
        dvbt2_54_time_interleaving_to_csv(
            "../../ekt_json/dvbt2_54_time_interleaving.json",
            "../../ekt_test_report/dvbt2_54_time_interleaving.csv")

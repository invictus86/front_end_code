...
PARAMETER_LIST = [["ON", None], ["OFF", None]]

my_file = Path("../../ekt_json/dvbt2_37_modes_supplument_1_rotation.json")
if my_file.exists():
    pass
else:
    dict_test_parame_result = {}
    dict_test_parame_result["test_parame_result"] = PARAMETER_LIST
    write_json_file("../../ekt_json/dvbt2_37_modes_supplument_1_rotation.json", dict_test_parame_result)
...
if __name__ == '__main__':
    ...
    """
    load_dict = read_json_file("../../ekt_json/dvbt2_37_modes_supplument_1_rotation.json")
    sfu_ip = "192.168.1.50"
    ...
    specan = Ektsfu(sfu_ip)
    specan.set_digitaltv_coding_constellation_dvbt(MODULATION_256QAM)
    specan = Ektsfu(sfu_ip)
    ...
    for PARAME in load_dict.get("test_parame_result"):
        ...
        write_json_file("../../ekt_json/dvbt2_37_modes_supplument_1_rotation.json", load_dict)
        dvbt2_37_modes_supplument_1_json_to_csv(
            "../../ekt_json/dvbt2_37_modes_supplument_1_rotation.json",
            "../../ekt_test_report/dvbt2_37_modes_supplument_1_rotation.csv")

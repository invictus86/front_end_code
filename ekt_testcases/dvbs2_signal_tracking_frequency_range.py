                ...
                for FREQUENCY_OFFSET in SYMBOL_RATE_FREQUENCY[2]:
                    ...
                    if lock_state == "1":
                        ...
                        write_test_result("../ekt_log/test_result_sfu.txt",
                                          (
                                                      "dvbs2_signal_tracking_frequency_range: current_time:{}, coderate：{}, frequency：{} MHz，symbol_rate：{} Ksym/s，{}".format(
                                                          datetime.datetime.now().strftime('%Y-%m-%d %H:%M:%S'),
                                                          code_rate_cn[0], FREQUENCY_OFFSET[1],
                                                          SYMBOL_RATE_FREQUENCY[1],
                                                          "锁台失败") + "\n"))
                        continue
                    else:
                    ...
                    try:
                        ...
                        print "dvbs2_signal_tracking_frequency_range: current_time:{}, coderate：{}, frequency：{} MHz，symbol_rate：{} Ksym/s，马赛克检测结果：{}".format(
                        ...
                        write_test_result("../ekt_log/test_result_sfu.txt",
                                          "dvbs2_signal_tracking_frequency_range: current_time:{}, coderate：{}, frequency：{} MHz，symbol_rate：{} Ksym/s，马赛克检测结果：{}".format(
                                              datetime.datetime.now().strftime('%Y-%m-%d %H:%M:%S'), code_rate_cn[0],
